...
function Header() {
	...
	const [isHiddenArticlesVisible, setIsHiddenArticlesVisible] = useState(false);
    ...
    setIsHiddenArticlesVisible(!isHiddenArticlesVisible);
	}
		...
		if (isModalVisible) {
			...
			userSection =
				<div className={styles.headerIcons}>
					...
					<FontAwesomeIcon onClick={handleRemoveArticlesClick} className={styles.userSection} icon={faEye} />
				</div>
		}
	}
